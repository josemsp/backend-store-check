...
import { InviteUserController, AcceptInvitationController, ValidateInvitationController } from './invitations.controllers';

export const invitationsPluginPrivate: WorkerModule = {
	name: 'invitations-private',
	basePath: '/api/v1/invitations',
	middleware: [authMiddleware],
	routes: [{ method: 'post', path: '/', handler: InviteUserController }],
};
