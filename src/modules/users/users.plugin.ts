...
import { GetUserController, GetMeController, UpdateUserController, AssignUserPermissionsController } from './users.controller';
...
export const usersPlugin: WorkerModule = {
	...
	routes: [
		...
		{ method: 'post', path: '/:id/permissions', handler: AssignUserPermissionsController },
	],
};
